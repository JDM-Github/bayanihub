...
<section class="bg-yellowish3 sm:py-4 md:py-6 lg:py-8 lg:px-32 md:px-16 sm:px-4 mt-1 relative">
    <div class="swiper">
                ...
                <div class="swiper-slide">
                    <div class="relative bg-white shadow-xl rounded-lg overflow-hidden flex flex-col md:flex-row items-center md:items-start">
                        ...
                        <div class="relative w-full md:w-1/2 h-52 md:h-96">
                            ...
                            {/await}
                            <div class="absolute inset-0 lg:bg-gradient-to-r from-gray-900/60 via-transparent to-yellowish/100"></div>
                        </div>

                        <div class="p-6 md:w-1/2 bg-yellowish flex flex-col justify-between h-auto md:h-96">
                            <div>
                                <span class="text-yellowish4 text-sm md:text-lg font-semibold">{story.category}</span>
                            ...
                            <button
                                class="mt-4 px-4 py-2 text-sm md:text-base bg-yellowish4 text-yellowish font-semibold rounded-lg shadow-md hover:bg-yellowish3 transition cursor-pointer"
